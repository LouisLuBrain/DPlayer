...
class Template {
    ...
    init() {
        ...
        this.container.innerHTML = tplPlayer(templateOptions);
        ...
        this.loop = this.container.querySelector('.dplayer-setting .dplayer-setting-loop');
        this.loopMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-setting-loop');
        this.loopToggle = this.container.querySelector('.dplayer-setting .dplayer-setting-loop .dplayer-toggle-setting-input');
        this.loopToggleMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-setting-loop .dplayer-toggle-setting-input');
        ...
        this.danmakuOpacityThumb = this.container.querySelector('.dplayer-setting .dplayer-opacity-thumb');
        this.danmakuOpacityBar = this.container.querySelector('.dplayer-setting .dplayer-danmaku-bar-inner');
        this.danmakuOpacityBarWrap = this.container.querySelector('.dplayer-setting .dplayer-danmaku-bar');
        this.danmakuOpacityBarWrapWrap = this.container.querySelector('.dplayer-setting .dplayer-danmaku-bar-wrap');
        this.danmakuOpacityBox = this.container.querySelector('.dplayer-setting .dplayer-setting-danmaku');
        this.danmakuOpacityThumbMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-opacity-thumb');
        this.danmakuOpacityBarMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-danmaku-bar-inner');
        this.danmakuOpacityBarWrapMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-danmaku-bar');
        this.danmakuOpacityBarWrapWrapMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-danmaku-bar-wrap');
        this.danmakuOpacityBoxMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-setting-danmaku');
        this.danmakuSpeedBar = this.container.querySelector('.dplayer-setting .dplayer-danmaku-speed-inner');
        this.danmakuSpeedBarWrap = this.container.querySelector('.dplayer-setting .dplayer-danmaku-speed');
        this.danmakuSpeedBarWrapWrap = this.container.querySelector('.dplayer-setting .dplayer-danmaku-speed-wrap');
        this.danmakuSpeedBox = this.container.querySelector('.dplayer-setting .dplayer-setting-danmaku-speed');
        this.danmakuSpeedBarMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-danmaku-speed-inner');
        this.danmakuSpeedBarWrapMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-danmaku-speed');
        this.danmakuSpeedBarWrapWrapMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-danmaku-speed-wrap');
        this.danmakuSpeedBoxMobile = this.container.querySelector('.dplayer-settingmobile .dplayer-setting-danmaku-speed');
        ...
        this.commentCounter = this.container.querySelector('.dplayer-comment-input-counter');
